...
<%--保留此处 end--%>
<rapid:override name="title">&nbsp;·&nbsp;编辑页面
</rapid:override>
...
<rapid:override name="content">
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page">页面列表</a>
              <a><cite>新建页面</cite></a>
        </span>
    </blockquote>
    ...
    <form class="layui-form" method="post" id="myForm"
          action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page/insertSubmit">
