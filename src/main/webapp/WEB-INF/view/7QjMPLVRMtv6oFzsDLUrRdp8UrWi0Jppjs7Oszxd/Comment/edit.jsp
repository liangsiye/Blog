...
<%@ page import="com.che.blog.util.Functions" %>
...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/comment">评论列表</a>
              <a><cite>编辑评论</cite></a>
        </span>
    </blockquote>

    <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/comment/editSubmit">
        <input type="hidden" name="commentId" value="${comment.commentId}">
        <div class="layui-form-item">
            <label class="layui-form-label">昵称 </label>
            <div class="layui-input-block">
                <%--<input type="text" name="commentAuthorName"  value="曹操凹槽从哦草哦草" class="layui-input">--%>
