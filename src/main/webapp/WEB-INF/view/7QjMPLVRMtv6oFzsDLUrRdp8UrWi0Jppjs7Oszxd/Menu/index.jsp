...
<%@ taglib prefix="rapid" uri="http://www.rapid-framework.org.cn/rapid" %>
    ...
    <rapid:override name="title">&nbsp;·&nbsp;菜单列表
    </rapid:override>
...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu/insertSubmit">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        URL
                        <span style="color: #FF5722; ">*</span>
                        <input type="text" name="menuUrl" placeholder="如：http://che.com/message.html" autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">
                        图标
                        ...
                        <table class="layui-table" >
                            ...
                            <c:forEach items="${menuList}" var="m">
                                ...
                                <tr>
                                    ...
                                    <td>${m.menuOrder}</td>
                                    <td>
                                        <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu/edit/${m.menuId}" class="layui-btn layui-btn-mini" title="点击编辑">编辑</a>
                                        <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu/delete/${m.menuId}" class="layui-btn layui-btn-danger layui-btn-mini" title="点击删除" onclick="return confirmDelete()">删除</a>
                                    </td>
                                    <td >${m.menuId}</td>
                                </tr>
                                </c:if>
