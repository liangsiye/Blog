...
<rapid:override name="title">&nbsp;·&nbsp;编辑菜单项目
</rapid:override>
...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
          ...
          <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd">首页</a>
          <%--<a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu">菜单内容列表</a>--%>
          <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu">菜单内容列表</a>
    ...
    <div class="layui-row">
        <div class="layui-col-md4" >
            <%--<form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu/editSubmit">--%>
            <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/menu/editSubmit">
