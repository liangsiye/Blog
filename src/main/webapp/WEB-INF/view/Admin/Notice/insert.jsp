...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/notice">公告列表</a>
              <a><cite>添加公告</cite></a>
        </span>
    </blockquote>

    <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/notice/insertSubmit">
