                                    ...
                                    <li class="comment   thread-even comment-item approved">
                                        ...
                                        <div class="dashboard-comment-wrap has-row-actions">
                                            ...
                                            <a data-comment-id="1268"
                                               ...
                                               href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/comment/reply/${c.commentId}">
                                                回复
                                            </a>
                                            </span>
                                                <span class=""> |
                                                <%--<a href="/admin/comment/edit/${c.commentId}">编辑</a>--%>
                                                <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/comment/edit/${c.commentId}">编辑</a>
                                            </span>
                                                <span class=""> |
            ...
            <div id="dashboard_quick_press" class="postbox ">
                <div class="inside">
                    <form name="post" method="post" id="insertDraftForm"
                          ...
                          class="initial-form hide-if-no-js" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article/insertDraftSubmit">
                    ...
                    <div class="drafts"><p class="view-all"><a
                            <%--href="/admin/article"--%>
                            href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article"
                                ...
                                <c:if test="${a.articleStatus==0}">
                                    <li>
                                        <div class="draft-title"><a
                                                ...
                                                href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article/edit/${a.articleId}">${a.articleTitle}</a>
