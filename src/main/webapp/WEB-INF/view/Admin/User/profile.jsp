...
<rapid:override name="title">&nbsp;·&nbsp;编辑用户
</rapid:override>
...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
         <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd">首页</a>
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/user">用户列表</a>
              <%--<a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/user">用户列表</a>--%>
              <c:choose>
    ...
    <br><br>
    <form class="layui-form" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/user/editSubmit" id="userForm"
          method="post">
        <input type="hidden" name="userId" id="userId" value="${user.userId}">
        <div class="layui-form-item">
            <a class="layui-btn layui-btn-primary"  href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/user/edit/${user.userId}">编辑</a>
