...
<%--保留此处 end--%>
<rapid:override name="title">&nbsp;·&nbsp;修改文章
</rapid:override>
...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article/editSubmit">
    ...
    <blockquote class="layui-elem-quote layui-quote-nm">
        温馨提示：
        1、插入代码前，可以点击 <a href="http://che.com/code-highlight.html" target="_blank">代码高亮</a>,将代码转成HTML格式
    </blockquote>
