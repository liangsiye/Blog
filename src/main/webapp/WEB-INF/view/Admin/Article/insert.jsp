...
<%--保留此处 end--%>
    <rapid:override name="title">&nbsp;·&nbsp;新建文章
    </rapid:override>
...
<rapid:override name="content">
    <blockquote class="layui-elem-quote">
         <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article">文章列表</a>
              <a><cite>添加文章</cite></a>
        </span>
    </blockquote>
    ...
    <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/article/insertSubmit">
        ...
        <blockquote class="layui-elem-quote layui-quote-nm">
            ...
            3、插入代码前，可以点击 <a href="http://che.com/code-highlight.html" target="_blank">代码高亮</a>,将代码转成HTML格式
