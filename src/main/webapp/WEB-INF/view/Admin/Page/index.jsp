...
<rapid:override name="title">&nbsp;·&nbsp;页面列表
</rapid:override>
            ...
            <c:forEach items="${pageList}" var="p">
                <c:if test="${p.pageStatus!=2}">
                    <tr>
                        ...
                        <td>
                            <%--<a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page/edit/${p.pageId}"--%>
                            <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page/edit/${p.pageId}"
                               class="layui-btn layui-btn-mini">编辑</a>
                            <%--<a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page/delete/${p.pageId}"--%>
                            <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/page/delete/${p.pageId}"
