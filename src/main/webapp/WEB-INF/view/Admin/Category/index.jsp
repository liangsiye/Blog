...
<%@ taglib prefix="rapid" uri="http://www.rapid-framework.org.cn/rapid" %>
    ...
    <rapid:override name="title">&nbsp;·&nbsp;分类列表
    </rapid:override>
...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
              <%--<a href="/admin">首页</a>--%>
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd">首页</a>
              <%--<a href="/admin/category">分类列表</a>--%>
              <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category">分类列表</a>
              <a><cite>添加分类</cite></a>
        </span>
    </blockquote>
    <div class="layui-row">
        <div class="layui-col-md4">
            ...
            <form class="layui-form"  method="post" id="myForm" action="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category/insertSubmit">
                    ...
                    <c:if test="${c.categoryPid==0}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category/edit/${c.categoryId}" class="layui-btn layui-btn-mini">编辑</a>
                                <c:if test="${c.articleCount==0}">
                                    ...
                                    <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category/delete/${c.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
                                </c:if>
                            </td>
                            <td>${c.categoryId}</td>
                            <td>${c.categoryPid}</td>
                            ...
                            <c:if test="${c2.categoryPid==c.categoryId}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category/edit/${c2.categoryId}" class="layui-btn layui-btn-mini">编辑</a>
                                        <c:if test="${c2.articleCount==0}">
                                            ...
                                            <a href="/7QjMPLVRMtv6oFzsDLUrRdp8UrWi0Jppjs7Oszxd/category/delete/${c2.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
                                        </c:if>
                                    </td>
